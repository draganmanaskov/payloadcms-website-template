  ...
  return (
    <div className="mx-auto grid max-w-6xl items-start gap-6 px-4 py-6 md:grid-cols-2 lg:gap-12">
      <div className="grid gap-3 md:grid-cols-5 md:gap-3">
        <div className="flex justify-start  gap-3 overflow-auto md:order-first  md:max-h-[450px] md:flex-col lg:max-h-[640px] ">
          {images.map((image, index) => {
            return (
              ...
              >
                {/* <img
                  src={getDirectusImageUrl(image.id, 100, 120, 100)}
        ...
        <div className="relative order-first  md:col-span-4">
          {/* <img
            src={getDirectusImageUrl(images[imageIndex].id, 600, 900, 100)}
            alt="Product Image"
            width={600}
            height={900}
